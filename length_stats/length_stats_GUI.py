...
class LengthStatsGUI ( wx.Dialog ):
	
	def __init__( self, parent ):
		wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"Length stats", pos = wx.DefaultPosition, size = wx.Size( 353,478 ), style = wx.DEFAULT_DIALOG_STYLE|wx.RESIZE_BORDER )
